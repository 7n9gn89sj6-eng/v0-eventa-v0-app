  ...
  en: {
    ...
    form: {
      ...
      fields: {
        ...
        posterTitle: "Add a poster or banner",
        posterHint:
          "Drag and drop an image, or click below to choose a file. JPEG, PNG, or WebP · max 5 MB.",
        posterDropHint: "Drop an image here, or click to upload",
        posterReady: "Poster ready",
        posterRemove: "Remove image",
        posterLinkFallback: "Or use an image link instead",
  ...
  it: {
    ...
    form: {
      ...
      fields: {
        ...
        descriptionHint:
          "Includi ciò che rende speciale il tuo evento, cosa possono aspettarsi i partecipanti e dettagli importanti",
        address: "Indirizzo",
        ...
        posterTitle: "Aggiungi un poster o un banner",
        posterHint:
          "Trascina un'immagine qui o clicca per scegliere un file. JPEG, PNG o WebP · max 5 MB.",
        posterDropHint: "Trascina un'immagine qui o clicca per caricare",
        posterReady: "Immagine pronta",
        posterRemove: "Rimuovi immagine",
        posterLinkFallback: "Oppure usa un link all'immagine",
        ...
        required: "*",
        addressGuidance:
          "Coderemo automaticamente questo indirizzo per la visualizzazione sulla mappa e i calcoli di distanza.",
      },
      validation: {
      ...
      alerts: {
        prefilled:
          "Abbiamo precompilato alcuni campi in base alla tua bozza. Controlla e completa i dettagli rimanenti.",
      },
      buttons: {
        submit: "Invia Evento",
      ...
      errors: {
        serverConfig:
          "Il server non è configurato correttamente. Contatta il supporto o verifica che tutte le variabili d'ambiente richieste siano impostate nella sezione Vars.",
  ...
  el: {
    ...
    form: {
      ...
      fields: {
        ...
        descriptionHint:
          "Συμπεριλάβετε τι κάνει την εκδήλωσή σας ξεχωριστή, τι μπορούν να περιμένουν οι συμμετέχοντες και σημαντικές λεπτομέρειες",
        address: "Διεύθυνση",
        ...
        posterTitle: "Προσθέστε αφίσα ή banner",
        posterHint:
          "Σύρετε και αφήστε μια εικόνα ή κάντε κλικ για επιλογή αρχείου. JPEG, PNG ή WebP · έως 5 MB.",
        posterDropHint: "Αφήστε εδώ μια εικόνα ή κάντε κλικ για μεταφόρτωση",
        posterReady: "Η εικόνα είναι έτοιμη",
        posterRemove: "Αφαίρεση εικόνας",
        posterLinkFallback: "Ή χρησιμοποιήστε σύνδεσμο εικόνας",
        ...
        required: "*",
        addressGuidance:
          "Θα κωδικοποιηθεί αυτή η διεύθυνση αυτόματα για εμφάνιση στον χάρτη και υπολογισμούς αποστάσεων.",
      },
      validation: {
      ...
      alerts: {
        prefilled:
          "Έχουμε prefilled ορισμένα πεδία με βάση τη δική σας προσχέδιο. Παρακαλώ ελέγξτε και συμπληρώστε τα υπόλοιπα στοιχεία.",
      },
      buttons: {
      ...
      errors: {
        serverConfig:
          "Ο διακομιστής δεν είναι σωστά ρυθμισμένος. Παρακαλώ επικοινωνήστε με την υποστήριξη ή ελέγξτε ότι όλες οι απαιτούμενες μεταβλητές περιβάλλοντος έχουν οριστεί στην ενότητα Vars.",
  ...
  es: {
    ...
    form: {
      ...
      fields: {
        ...
        descriptionHint:
          "Incluye qué hace especial tu evento, qué pueden esperar los asistentes y detalles importantes",
        address: "Dirección",
        ...
        posterTitle: "Añade un póster o banner",
        posterHint:
          "Arrastra y suelta una imagen, o haz clic para elegir un archivo. JPEG, PNG o WebP · máx. 5 MB.",
        posterDropHint: "Suelta una imagen aquí o haz clic para subir",
        posterReady: "Imagen lista",
        posterRemove: "Quitar imagen",
        posterLinkFallback: "O usa un enlace a la imagen",
        ...
        required: "*",
        addressGuidance:
          "Codificaremos automáticamente esta dirección para la visualización en el mapa y los cálculos de distancia.",
      },
      validation: {
      ...
      alerts: {
        prefilled:
          "Hemos pre-rellenado algunos campos basándonos en tu borrador. Por favor revisa y completa los detalles restantes.",
      },
      buttons: {
      ...
      errors: {
        serverConfig:
          "El servidor no está configurado correctamente. Por favor contacta al soporte o verifica que todas las variables de entorno requeridas estén configuradas en la sección Vars.",
  ...
  fr: {
    ...
    form: {
      ...
      fields: {
        ...
        descriptionHint:
          "Incluez ce qui rend votre événement spécial, ce que les participants peuvent attendre et les détails importants",
        address: "Adresse",
        ...
        posterTitle: "Ajouter une affiche ou une bannière",
        posterHint:
          "Glissez-déposez une image ou cliquez pour choisir un fichier. JPEG, PNG ou WebP · max 5 Mo.",
        posterDropHint: "Déposez une image ici ou cliquez pour téléverser",
        posterReady: "Image prête",
        posterRemove: "Retirer l'image",
        posterLinkFallback: "Ou utilisez un lien vers l'image",
        ...
        required: "*",
        addressGuidance:
          "Nous coderons automatiquement cette adresse pour l'affichage sur la carte et les calculs de distance.",
      },
      validation: {
      ...
      alerts: {
        prefilled:
          "Nous avons pré-rempli certains champs en fonction de votre brouillon. Veuillez vérifier et compléter les détails restants.",
      },
      buttons: {
      ...
      errors: {
        serverConfig:
          "Le serveur n'est pas correctement configuré. Veuillez contacter le support ou vérifier que toutes les variables d'environnement requises sont définies dans la section Vars.",
